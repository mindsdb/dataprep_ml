...
class TestInferTypes(unittest.TestCase):
    def test_analyze_home_rentals(self):
        ...
        target = 'rental_price'
        type_information = analyze_dataset(df, target).type_information
        ...
        self.assertTrue(type_information.dtypes[target] == dtype.float)
    ...
    def test_with_generated(self):
        ...
        analysis = analyze_dataset(df, target=df.columns[0])
